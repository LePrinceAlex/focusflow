...
🧠 Défis Techniques Relevés
    ...
    Le cercle de progression n'est pas une simple image, mais un tracé SVG piloté par les mathématiques :
        $Offset = Circonférence \times (1 - \frac{TempsRestant}{TempsTotal})$Cela permet une fluidité parfaite et une netteté absolue sur tous les écrans.
...
🚀 Installation & Lancement
    ...
    Installer les dépendances (Front & Back) :
        Bash
